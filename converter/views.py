...
TOOL_CONFIG = {
    ...
    'compress_pdf':     {'name': 'Compress PDF',        'icon': '🗜️',  'category': 'pdf',
                         ...
                         'meta_title': 'Compress PDF Online Free - Reduce File Size | ShiftDocs',
                         'meta_description': "Compress PDF files online for free in seconds. Reduce PDF size without losing quality. No signup, fast & secure. Try ShiftDocs' PDF compressor now!"},
    'merge_pdf':        {'name': 'Merge PDFs',          'icon': '🔗',  'category': 'pdf',
                         ...
                         'meta_title': 'Merge PDF Files Online Free - Combine PDFs | ShiftDocs',
                         'meta_description': 'Merge multiple PDF files into one document online for free. Fast, secure & easy PDF combiner no installation needed. Try ShiftDocs now!'},
    'split_pdf':        {'name': 'Split PDF',           'icon': '✂️',  'category': 'pdf',
                         ...
                         'meta_title': 'Split PDF Online Free - Separate PDF Pages | ShiftDocs',
                         'meta_description': 'Split PDF files into multiple documents or extract pages online for free. Fast, secure & easy to use. No software install. Try ShiftDocs today!'},
    ...
    'pdf_to_word':      {'name': 'PDF to Word',         'icon': '📝',  'category': 'pdf',
                         ...
                         'meta_title': 'PDF to Word Converter Free Online | ShiftDocs',
                         'meta_description': 'Convert PDF to Word (DOCX) online free with accurate formatting. Fast, secure & no signup required. Edit your PDFs in Word instantly with ShiftDocs.'},
    'pdf_to_excel':     {'name': 'PDF to Excel',        'icon': '📊',  'category': 'pdf',
                         'description': 'Extract tables and data from PDF into Excel (.xlsx).',
                         'accept': '.pdf', 'form': UploadForm, 'multi': False,
                         'meta_title': 'PDF to Excel Converter Free Online | ShiftDocs',
                         'meta_description': "Convert PDF to Excel (XLSX) online for free with accurate tables & data. Fast, secure & no installation. Try ShiftDocs' PDF to Excel tool now!"},
    'pdf_to_pptx':      {'name': 'PDF to PowerPoint',   'icon': '📑',  'category': 'pdf',
                         'description': 'Convert each PDF page into a PowerPoint slide.',
                         'accept': '.pdf', 'form': UploadForm, 'multi': False,
                         'meta_title': 'PDF to PPT Converter Free Online | ShiftDocs',
                         'meta_description': 'Convert PDF to PowerPoint (PPTX) online free in seconds. Keep formatting intact, fast & secure conversion. No signup needed. Try ShiftDocs now!'},
    ...
    'ocr_pdf':          {'name': 'OCR — Searchable PDF','icon': '🔍',  'category': 'pdf',
                         ...
                         'meta_title': 'OCR PDF Online Free - Convert Scanned PDF to Text | ShiftDocs',
                         'meta_description': 'Make scanned PDFs searchable & editable with free online OCR. Extract text accurately in seconds. Fast, secure & no install. Try ShiftDocs OCR now!'},
    'password_protect': {'name': 'Password Protect',    'icon': '🔒',  'category': 'pdf',
                         ...
                         'meta_title': 'Password Protect PDF Online Free | ShiftDocs',
                         'meta_description': 'Add a password to your PDF online for free to secure sensitive files. Fast encryption, no software install. Protect your PDF with ShiftDocs now!'},
    'unlock_pdf':       {'name': 'Unlock PDF',          'icon': '🔓',  'category': 'pdf',
                         ...
                         'meta_title': 'Unlock PDF Online Free - Remove PDF Password | ShiftDocs',
                         'meta_description': 'Remove password protection from PDF files online for free. Unlock secured PDFs instantly fast, safe & no install. Try ShiftDocs unlocker now!'},
    ...
    'docx_to_pdf':      {'name': 'DOCX to PDF',         'icon': '📄',  'category': 'office',
                         ...
                         'meta_title': 'Word to PDF Converter Free Online | ShiftDocs',
                         'meta_description': "Convert Word (DOCX) to PDF online for free with perfect formatting. Fast, secure & no signup required. Try ShiftDocs' Word to PDF tool today!"},
    'excel_to_pdf':     {'name': 'Excel to PDF',        'icon': '📈',  'category': 'office',
                         'description': 'Convert Excel spreadsheets to PDF.',
                         'accept': '.xlsx,.xls', 'form': UploadForm, 'multi': False,
                         'meta_title': 'Excel to PDF Converter Free Online | ShiftDocs',
                         'meta_description': 'Convert Excel (XLSX) spreadsheets to PDF online free, keeping layout & data intact. Fast, secure & no install needed. Try ShiftDocs now!'},
    ...
    'img_to_pdf':       {'name': 'Image to PDF',        'icon': '🗒️',  'category': 'image',
                         ...
                         'meta_title': 'Image to PDF Converter Free Online | ShiftDocs',
                         'meta_description': 'Convert JPG, PNG & other images to PDF online for free in seconds. Combine multiple images into one PDF. Fast & secure. Try ShiftDocs now!'},
